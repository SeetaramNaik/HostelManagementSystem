...
<h3 style="font-size: 30px;">Hostel Management System</h3>
    ...
    <h1>Seventh semester students list</h1>
...
while($row=mysqli_fetch_array($students)){
  ...
  echo "<td style='background-color:#fff;'>"; ?><a href="../delete_student.php?id=<?php echo $row["usn"]; ?>"> <button type="text/javascript" class='delete btn btn-primary'>Remove</button><?php echo "</td>" ;  echo "</tr>";
}
